...
| # | 컴포넌트 | 높이 | 설명 |
|:--:|----------|------|------|
| 1 | Scoreboard Ticker | 110px | 가로 스크롤 경기 목록 |
| 2 | Ad Banner | 100px | 광고 배너 |
| 3 | Game Header | 60px | 경기 제목 |
| 4 | Video Player | 16:9 | 메인 영상 |
| 5 | Stream Tabs | 50px | Streams/MultiView/Key Plays |
| 6 | Timeline | 40px | 진행 바 |
| 7 | Player Controls | 50px | 재생 컨트롤 |
