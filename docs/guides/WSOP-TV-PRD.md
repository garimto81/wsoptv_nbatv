...
![4단계 변환 프로세스](../images/mockups/conversion-process.png)

> **목업 파일**: [`conversion-process.html`](../mockups/conversion-process.html)

| 단계 | 산출물 | 설명 |
|:----:|--------|------|
| ① | NBA TV 스크린샷 | 실제 서비스 캡처 (27개 화면) |
| ② | NBA TV B&W 목업 | 흑백 와이어프레임 변환 (13개 HTML) |
| ③ | 분석 다이어그램 | 레이어별 UI 패턴 분석 (12개 오버레이) |
| ④ | WSOP TV B&W 목업 | 최종 WSOP TV 적용 목업 (16개 HTML) |
