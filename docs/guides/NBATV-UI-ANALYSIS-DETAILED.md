...
| 컴포넌트 | 높이 | 비율 |
|----------|------|------|
| Scoreboard Ticker | 110px | 12.2% |
| Ad Banner | 100px | 11.1% |
| Game Header | 60px | 6.7% |
| Video Player | ~480px (16:9) | 53.3% |
| Stream Tabs | 55px | 6.1% |
| Timeline | 40px | 4.4% |
| Player Controls | 65px | 7.2% |
| **Total** | **~900px** | **100%** |
